        ...
        @Using (Html.BeginForm())
            ...
            @<div class="form-horizontal">
                ...
                <div class="form-group">
                    @Html.LabelFor(Function(model) model.trait, htmlAttributes:=New With {.class = "control-label col-md-2 capital"})
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    @Html.LabelFor(Function(model) model.description, htmlAttributes:=New With {.class = "control-label col-md-2 capital"})
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        ...
                        @Html.ActionLink("Back to List", "ViewTraits", "Question", New With {.class = "btn btn-sm btn-info"})
                    </div>
                </div>
            </div>
        End Using
